...
{
    public class MyKartMovement : MonoBehaviour
    {
        ...
        {
            public MyKartMovement.Stats modifiers;
        ...
        public struct Stats
        {
            ...
            [Min(0.1f), Tooltip("Top speed attainable when moving forward.")]
        ...
        public MyKartMovement.Stats baseStats = new MyKartMovement.Stats
        {
            TopSpeed            = 10f,
            Acceleration        = 5f,
        ...
        MyKartMovement.Stats m_FinalStats;
        ...
        void FixedUpdate()
        {
            ...
            if (m_CanMove)
            {
                //MoveVehicle(In.Accelerate, In.Brake, In.TurnInput);

                //Aquí se mueve el vehiculo
                

                //Si das clic derecho los carros siguen al jugador
                if (Input.GetMouseButtonDown(1))
                {
                    targetTag = "MainPlayer";
                    FindClosestTarget();
                    Debug.Log("Al player");
        ...
        void GatherInputs()
        {
            ...
            {
                In = m_Inputs[i].GenerateInput();
                WantsToDrift = In.Brake && Vector3.Dot(Rigidbody.velocity, transform.forward) > 0.0f;
            }
        }
        ...
        public float LocalSpeed()
        {
            ...
            else
            {
                ...
                return In.Accelerate ? 1.0f : 0.0f;
            }
        }
        ...
        void MoveVehicle(bool accelerate, bool brake, float turnInput)
        {
            ...
            if (GroundPercent > 0.0f)
            {
                ...
                if (IsDrifting)
                {
                    ...
                    {
                        // No In, and car aligned with speed direction => Stop the drift
                        IsDrifting = false;
